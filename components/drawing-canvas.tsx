...
type Props = { mode?: "create" | "scribble"; targetPublicId?: string; baseImageUrl?: string };
...
export function DrawingCanvas({ mode = "create", targetPublicId, baseImageUrl }: Props) {
